...
//methods
User.prototype.LogToConsole(){

    console.log("User ID: {0}", this.ID);
    console.log("User Name ID: {0}", this.userName);
    console.log("User Password: {0}", this.password);
    console.log("User Email: {0}", this.email);
};
...
function inits() {
    var user = new User(1,"tttt","123","mama@ddd.com");
    user.LogToConsole();

    //creating object array
var user2 = new User(3,"tttt","123","mama@ddd.com");
    console.log(user2["user Nmae"]);
    console.log(user2.length);

    var mymarry=["asasa","ererer","ertert"];
    console.log(mymarry.length);


var user3 = new User(2,"tttt","123","mama@ddd.com")
    var users=[user,user3];
    console.log(users);
